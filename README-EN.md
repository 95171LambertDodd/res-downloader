...
> **Personal tip:** If captured resources are not showing up, try toggling the proxy off and on again — this often helps after the app has been running for a long time.
